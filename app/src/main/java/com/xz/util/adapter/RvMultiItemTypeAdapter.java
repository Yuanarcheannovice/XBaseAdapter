...
import com.xz.util.adapter.util.RvItemViewDelegate;
import com.xz.util.adapter.util.RvItemViewDelegateManager;
import com.xz.util.adapter.util.RvViewHolder;
import com.xz.util.adapter.util.RvWrapperUtils;
...
public class RvMultiItemTypeAdapter<T> extends RvDataAdapter<T> {
    ...
    protected boolean isEnabled(int viewType) {
        return viewType != BASE_ITEM_TYPE_HEADER && viewType != BASE_ITEM_TYPE_FOOTER;
    }
